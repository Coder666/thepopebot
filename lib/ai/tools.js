...
function createGetBranchFileTool({ repo, branch }) {
  return tool(
    ...
    },
    {
      ...
      description: 'Fetch the contents of a specific file from the feature branch. Use this to inspect code changes, review implementations, or understand what was modified during a coding session.',
      schema: z.object({ file_path: z.string().describe('Path to the file relative to the repository root (e.g. "src/index.js")') }),
    }
  );
}

export { createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getSkillBuildingGuideTool, getSkillDetailsTool, createStartCodingTool, createStartHeadlessCodingTool, createGetRepositoryDetailsTool, createGetBranchFileTool, createDelegateToPersonaTool, loadPersonasRegistry };
    },
    {
      name: 'get_branch_file',
      description: 'Fetch the contents of a specific file from the feature branch.',
      schema: z.object({ file_path: z.string().describe('Path to the file relative to the repository root') }),
    }
  );
}

export { createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getSkillBuildingGuideTool, getSkillDetailsTool, createStartCodingTool, createStartHeadlessCodingTool, createGetRepositoryDetailsTool, createGetBranchFileTool, createDelegateToPersonaTool };
      }),
    }
  );
}
